    ...
    <div class="presse__distinctions hide">
        <?php
            ...
            foreach ($postsDistinctions as $key => $distinction) {
                ...
                $youtubeLink = get_post_meta($distinctionID, 'youtube_link', true);
                if($video > 0) {
                    $paire = 0;
                    $class = 'item100';
                    ...
                    $class = 'item100';
                    $media = '<iframe style="width: 100%;" width="560" height="500" src="https://www.youtube.com/embed/'.$youtubeLink.'" frameborder="0" allowfullscreen></iframe>';
                } else {
                    $paire++;
